...
def crear_acceso():
	try:
		...
		objetivo = os.path.abspath('IPporEmail.exe')
...
def sitio_web():
	webbrowser.open_new_tab("https://darkfoe703.github.io/SNT-Web/index.html")

def mail_contacto():
	webbrowser.open_new_tab("https://darkfoe703.github.io/SNT-Web/pages/contacto.html")

def donacion_web():
	webbrowser.open_new_tab("https://darkfoe703.github.io/SNT-Web/pages/donaciones.html")
